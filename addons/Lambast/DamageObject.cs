...
namespace LambastNamespace
{
    ...
    public partial class DamageObject : Node3D
    {
        ...
        {
            CooldownTimer = this.GetNode<Timer>("Timer");
            ...
            DamageObjectAnimationPlayer = this.GetNode<AnimationPlayer>("AnimationPlayer");
            ...
            DamageObjectAudioStreamPlayer3D = this.GetNode<AudioStreamPlayer3D>("AudioStreamPlayer3D");
